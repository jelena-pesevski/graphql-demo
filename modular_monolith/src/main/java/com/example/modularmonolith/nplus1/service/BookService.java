...
public class BookService {
  ...
  private void initializeRepository() {
    ...
    bookRepository.put(3,
        new Book(3, "Sapiens: A Brief History of Humankind", "Yuval Noah Harari", "Random House Uk",
            18.75));
    bookRepository.put(4, new Book(4, "Atomic Habits", "James Clear", "Avery", 11.98));
    bookRepository.put(5,
        new Book(5, "The Subtle Art of Not Giving a F*ck", "Mark Manson", "Harper", 12.99));
  }
}
